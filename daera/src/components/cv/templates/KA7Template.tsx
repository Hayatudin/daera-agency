            ...
            <div className="w-[50%] border-r-2 border-black flex flex-col border-b border-b-transparent">
              ...
              <table className="w-full border-collapse mt-[-1px]">
                <thead>
                  ...
                  <tr>
                    <td className={`border border-black px-2 py-0.5 font-bold ${bgLightBlue} w-[35%]`}>Country</td>
                    <td className={`border border-black px-2 py-0.5 font-bold ${bgLightBlue} w-[35%]`}>Period</td>
                    <td className={`border border-black px-2 py-0.5 font-bold ${bgLightBlue} w-[30%]`}>Date</td>
                  </tr>
                </thead>
                <tbody>
                  <tr><td className="border border-black px-2 py-1 font-bold text-center h-[20px]"></td><td className="border border-black px-2 py-1 font-bold text-center"></td><td className="border border-black px-2 py-1 font-bold text-center"></td></tr>
                  <tr><td className="border border-black px-2 py-1 font-bold text-center h-[20px]">{expCountry}</td><td className="border border-black px-2 py-1 font-bold text-center">{expPeriod}</td><td className="border border-black px-2 py-1 font-bold text-center">{!expCountry ? 'N/A' : ''}</td></tr>
                </tbody>
              </table>
