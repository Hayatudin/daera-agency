    ...
    <div className="w-full max-w-[210mm] mx-auto bg-white text-black font-sans shadow-lg print:shadow-none" dir="ltr">
      ...
      <div className="p-[10mm] min-h-[297mm] box-border relative flex items-center justify-center break-before-page">
        {candidate.passportImageUrl ? (
          ...
          <div className="text-[#9ca3af] text-lg flex items-center justify-center w-full h-full border-2 border-dashed border-gray-300">Passport Image Not Available</div>
        )}
      </div>
    </div>
  );
